...
export default function Features() {
  return (
    <section>
      <Element className="featues">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {features.map(({ id, icon, caption, title, text, button }) => (
              <div
                key={id}
                className="relative md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320"
              >
                ...
                <p className="caption mb-12 max-md:mb-6">{caption}</p>
                <h2 className="max-w-400 mb-7 h3 tex-p4 max-md:mb-6 max-md:h5">   
                  {title}
                </h2>
